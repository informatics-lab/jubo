...
setup(
    ...
    description='A JupyterServer extention (though could be used stand alone) for converting notebooks into bokeh apps and deploying them.',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/met-office-lab/jubo',
    ...
    install_requires=['boto3','bokeh','gfm','tornado','notebook']
